      ...
      <aside class="main-sidebar hidden-print">
        <section class="sidebar">
          <div class="user-panel">
            <div class="pull-left image"><img class="img-circle" src="https://www.w3schools.com/bootstrap4/img_avatar1.png" alt="User Image"></div>
          ...
          <ul class="sidebar-menu">
            <!-- href = index.php ruta de la pagina principal -->
            <li class="active"><a href="index.php"><i class="fa fa-dashboard"></i><span>Dashboard</span></a></li>
            <li class="treeview"><a href="#"><i class="fa fa-laptop"></i><span>Productos</span><i class="fa fa-angle-right"></i></a>
              <ul class="treeview-menu">
                <!-- ?c=producto  ruta de la lista-->
                <li><a href="?c=producto"><i class="fa fa-circle-o"></i>Listar Productos</a></li>
